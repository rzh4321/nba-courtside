  ...
  return (
    <VStack gap={5}>
      ...
      <TeamStatistic
        ...
        leftColor={colorsTooSimilar(boxscore.awayTeam.teamTricode, boxscore.homeTeam.teamTricode) ? '#1F3CFA' : teamColors[boxscore.awayTeam.teamTricode]}
        rightColor={colorsTooSimilar(boxscore.awayTeam.teamTricode, boxscore.homeTeam.teamTricode) ? '#CBF717' : teamColors[boxscore.homeTeam.teamTricode]}
      />
      <TeamStatistic
        label="3 Pointers"
